...
const EditNode = ({ node, trigger, isOpen: controlledOpen, onClose }: EditNodeProps) => {
  ...
  const mutation = useMutation({
    mutationFn: (data: NodeUpdateForm) => NodesService.updateNode({ id: node.id, requestBody: data }),
    onSuccess: () => { showSuccessToast("节点更新成功"); reset(); closeDialog() },
