...
import type { NodeCreate } from "@/client/types.gen"
...
const AddNode = () => {
  ...
  const mutation = useMutation({
    mutationFn: (data: NodeCreate) =>
      NodesService.createNode({ requestBody: data }),
    onSuccess: () => {
  ...
  const onSubmit: SubmitHandler<NodeCreate> = (data) => {
