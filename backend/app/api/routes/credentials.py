...
from app.models import Credential, CredentialCreate, CredentialPublic, CredentialsPublic, CredentialUpdate, Message
...
def create_credential(
    *, session: SessionDep, current_user: CurrentUser, credential_in: CredentialCreate
    ...
    """
    credential = Credential.model_validate(credential_in, update={"owner_id": current_user.id})
